...
const questions = JSON.parse(fs.readFileSync('import_tireoide.json', 'utf8'));
const packageId = 'f90b96f6-66b4-47e6-a80f-e0cc70c17f71';
const subjectSlug = 'tireoide';
const specialtySlug = 'endocrinologia';
...
fs.writeFileSync('import_tireoide.sql', sql);
console.log('SQL generated successfully for Endocrinologia - Tireoide.');
