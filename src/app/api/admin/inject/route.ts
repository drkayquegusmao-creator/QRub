...
// Use same questions generated earlier
const questions = [
    {
...
const StringUtilComputeHash = (text: string) => {
...
export async function GET(req: Request) {
    ...
    const packageId = searchParams.get('package_id') || '810cdf77-da86-4cb8-abc1-81cf50dc65cb';
    ...
    for (let i = 0; i < questions.length; i++) {
        ...
        // Check duplicates
        const { data: existingPkg, error: selErr } = await supabase
