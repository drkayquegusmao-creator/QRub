...
import { Activity, ArrowLeft, BookOpen, ChevronRight, HardHat, Loader2, Sparkles } from 'lucide-react'
        ...
        return (
            <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20">
                <div className="min-h-screen flex flex-col items-center justify-center p-6">
                    ...
                    <p className="mt-4 text-xs font-black uppercase tracking-widest text-muted-foreground">Validando acesso...</p>
                </div>
            </div>
        )
    }
        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-4xl relative z-10">
                <div className="text-center mb-12">
                    ...
                    >
                        <div className="relative w-12 h-12 overflow-hidden rounded-xl shadow-lg border border-primary/10">
                            <Image src="/logo-icon.jpg" alt="QRub Logo" fill className="object-cover" />
                        </div>
                        <span className="text-3xl font-black italic uppercase tracking-tighter text-primary">QRub</span>
                    </motion.div>
                    <motion.h1 
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.1 }}
                        className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-4 text-[#0c1322] dark:text-white"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-black uppercase tracking-tight text-[#0c1322] dark:text-white mb-4">
                            QRub Saúde
                        </h2>
                ...
                >
                    <button 
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 text-xs font-bold uppercase tracking-widest text-slate-400 hover:text-white transition-colors group cursor-pointer"
                    >
