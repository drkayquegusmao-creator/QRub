...
export function ConcursoSidebar() {
    ...
    return (
        <aside 
            className={cn(
                "hidden md:flex flex-col fixed left-0 top-0 h-screen bg-[#1A1033] text-white border-r border-white/5 transition-all duration-500 ease-in-out z-50 overflow-hidden",
                collapsed ? "w-20" : "w-64"
            )}
        >
            {/* Header / Logo */}
            <div className="p-8 pb-4 flex items-center justify-between">
                <Link href="/concursos" className="flex items-center gap-3">
